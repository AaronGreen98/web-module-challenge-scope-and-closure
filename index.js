...
/*Task 1: counterMaker()
  ...
  counter2 has a variable outside of the function.
  2. Which of the two uses a closure? How can you tell?
  counter2 uses a closure because it has a variable outside of the function and counter1 uses closure because it has two different functions.
  3. In what scenario would the counter1 code be preferable? In what scenario would 
     counter2 be better?  counter2 would be preferable when you wanted to change the variable name.
*/
